...
import com.example.practica_final.activities.MessagesActivity;
import com.example.practica_final.activities.ProfileActivity;
import com.example.practica_final.users.User;

public class FriendChatHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public FriendChatHolder(LayoutInflater inflater, ViewGroup parent, Activity activity) {
