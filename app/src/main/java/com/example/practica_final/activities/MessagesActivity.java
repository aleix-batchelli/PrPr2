...
public class MessagesActivity extends AppCompatActivity {
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    Message[] messages = convertJSONArrayToUsers(messagesArray);
    ...
    private Message[] convertJSONArrayToUsers(JSONArray jsonArray) {
        ...
        try {
            for (int i = 0; i < length; i++) {
                ...
                String content = messageObject.getString("name");
